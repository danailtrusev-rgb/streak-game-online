...
export const cashoutContent = {
  ...
  error: {
    ...
    // The server independently verified the pot/streak this decision was
    // made against and found it no longer matches (e.g. this screen was
    // left open while a new run started elsewhere). Never a false
    // success — always ask for a refresh before trying again.
    staleContextTitle: 'This view is out of date',
    staleContextBody: 'Your streak or pot has changed since this screen opened. Refresh to see the current state before trying again.',
    missingContextTitle: 'Cashout is not available right now',
    missingContextBody: "We couldn't confirm your current game state. Please refresh and try again.",
    refreshCta: 'Refresh',
