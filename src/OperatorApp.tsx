  ...
  return (
    <BrowserRouter basename={basePath}>
      <RequireOperatorSession status={status}>
        <Routes>
          <Route path="/" element={<OperatorOverviewPage onLockAccess={lock} />} />
          <Route path="/overview" element={<OperatorOverviewPage onLockAccess={lock} />} />
          <Route path="/contact" element={<OperatorContactPage onLockAccess={lock} />} />
          <Route path="/deck" element={<OperatorDeckPage onLockAccess={lock} />} />
          <Route path="*" element={<OperatorOverviewPage onLockAccess={lock} />} />
        </Routes>
