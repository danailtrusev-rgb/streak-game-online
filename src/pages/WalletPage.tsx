...
const TYPE_CONFIG: Record<string, { label: string; icon: typeof ArrowUpCircle; iconSrc: string; positive: boolean }> = {
  TOPUP:           { label: 'Top Up',      icon: ArrowUpCircle,   iconSrc: ICONS.arrow_up,   positive: true  },
  STAKE:           { label: 'Stake',        icon: ArrowDownCircle, iconSrc: ICONS.arrow_down, positive: false },
  CASHOUT:         { label: 'Cashout',      icon: Sparkles,        iconSrc: ICONS.sparkles,   positive: true  },
  ADMIN_ADJUST:    { label: 'Adjustment',   icon: Shield,          iconSrc: ICONS.shield,     positive: true  },
  JACKPOT_CONTRIB: { label: 'Jackpot',      icon: RefreshCw,       iconSrc: ICONS.refresh,    positive: false },
  JACKPOT_WIN:     { label: 'Jackpot Win',  icon: Sparkles,        iconSrc: ICONS.sparkles,   positive: true  },
};
