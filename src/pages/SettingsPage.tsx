...
import StreakRemindersCard from '../components/settings/StreakRemindersCard';
...
export default function SettingsPage() {
  ...
  return (
    <div className="pg-transition pg-transition--fade-up" style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
      ...
      {/* Streak Reminders (Web Push) — separate from the verified-channel
          system above; available to guest accounts too, since it only
          needs a real auth.uid(), not an upgraded/verified contact. */}
      <div>
        <StreakRemindersCard />
      </div>
