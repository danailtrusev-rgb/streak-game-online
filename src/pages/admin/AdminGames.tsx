...
import { Gamepad2, ChevronDown, ChevronUp, Check, X } from 'lucide-react';
          ...
          <div key={game.game_id} className="border border-moss-dark/20 bg-ritual-surface/20">
            ...
            >
              <div className="flex items-center gap-3">
                <div className={`h-2 w-2 rounded-full ${game.launch_state === 'live' ? 'bg-moss-light' : game.launch_state === 'beta' ? 'bg-torch-ember' : 'bg-bone-faint'}`} />
            ...
            {isOpen && (
              <div className="border-t border-moss-dark/20 px-4 py-4 space-y-4">
                ...
                <div className="flex items-center gap-2 pt-1">
                  ...
                  <button
                    onClick={() => {
                      setEditValues((prev) => ({ ...prev, [game.game_id]: { ...game } }));
                    }}
