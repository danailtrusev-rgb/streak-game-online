...
const CARDS: ConfigCard[] = [
  ...
  },
  {
    key: 'push',
    icon: <Bell className="h-4 w-4 text-torch-ember" strokeWidth={1.5} />,
    title: 'Reactivation Notifications',
    description: 'Native Web Push — next-day and last-call reminders, timing, and default copy.',
  },
  {
    key: 'game_time',
    icon: <Clock className="h-4 w-4 text-torch-ember" strokeWidth={1.5} />,
    title: 'Game Time System',
    description: 'Global vs. Regional Game Time, rollover, and Saturday/Sunday timing foundation.',
  },
  {
    key: 'integrations',
