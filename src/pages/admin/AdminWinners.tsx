    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          {saveMsg && <span className="text-[10px] text-moss-light">{saveMsg}</span>}
          <button
      ...
      {showCreate && (
        <div className="border border-torch-orange/20 bg-torch-orange/5 px-4 py-4 space-y-3">
          <div className="text-[9px] uppercase tracking-[0.2em] text-bone-faint">Announce Winner</div>
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <label className="block text-[9px] uppercase tracking-[0.15em] text-bone-faint mb-1.5">Event Date</label>
            ...
            <div className="col-span-2">
              <label className="block text-[9px] uppercase tracking-[0.15em] text-bone-faint mb-1.5">Result Summary</label>
            ...
            <div className="col-span-2">
              <label className="block text-[9px] uppercase tracking-[0.15em] text-bone-faint mb-1.5">Share Text</label>
          ...
          <div key={w.id} className="border border-moss-dark/20 bg-ritual-surface/20 px-4 py-3">
            <div className="flex items-start justify-between">
              <div>
                ...
                <div className="text-[9px] text-bone-faint mt-0.5">{eventLabel(w.event_game_id)} · {w.event_date}</div>
                {w.result_summary && (
                  <div className="text-[10px] text-bone-muted mt-1.5">{w.result_summary}</div>
                )}
              </div>
              <div className="text-right flex-shrink-0 ml-3">
                ...
                <div className="text-[8px] uppercase tracking-[0.15em] text-bone-faint">Credits</div>
              </div>
            </div>
          </div>
        ))}
