/*
  ...
  - Drops dead 2-arg overload, fixes response shape to match frontend
  - Region-scoped: resolves region, week, event_date
  - Window check only when region has configured window; preserves Global mode
  - Clean idempotent 'already_entered' response for double-entry race
*/
